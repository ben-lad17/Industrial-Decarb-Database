...
# Ben Ladabaum                  
#                               
# Description:  Facility emissions data for animal slaughtering (non-poultry)
#
# Notes:  
# 
# Inputs:   
...
animal_slaughtering_emissions_by_facility = subpart_c_emissions |>
...
animal_slaughtering_emissions_by_facility_2023 = animal_slaughtering_emissions_by_facility |>
...
export_facility_unit_data(
  ...
  file_type = "facility",
  datasets = list(
    "facility_emissions" = animal_slaughtering_emissions_by_facility,
    "facility_emissions_2023" = animal_slaughtering_emissions_by_facility_2023
  )
)