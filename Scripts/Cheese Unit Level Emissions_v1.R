...
cheese_emissions_by_unit = subpart_c 
...
cheese_emissions_by_unit_2023 = cheese_emissions_by_unit |>
...
export_facility_unit_data(
  ...
  file_type = "unit",
  datasets = list(
    "unit_emissions" = cheese_emissions_by_unit,
    "unit_emissions_2023" = cheese_emissions_by_unit_2023
  )
)
