...
### load data
# subpart x
subpart_x_emissions = read_excel(here("Data/Subpart X", "x_subpart_level_information.xlsx")) |>
...
subpart_g_emissions = read_excel(here("Data/Subpart G", "g_subpart_level_information.xlsx")) |>
  pivot_wider(names_from = ghg_name, values_from = ghg_quantity) |>
  clean_names()  |>
...
subpart_v_emissions = read_excel(here("Data/Subpart V", "v_subpart_level_information.xlsx")) |>
  pivot_wider(names_from = ghg_name, values_from = ghg_quantity) |>
  clean_names()  |>
  rename(nitrous_oxide_subpart_v = nitrous_oxide)

# export
write_xlsx(subpart_x_emissions, path = here("Output", "subpart_x_emissions_by_facility_v1.xlsx"))
write_xlsx(subpart_g_emissions, path = here("Output", "subpart_g_emissions_by_facility_v1.xlsx"))
write_xlsx(subpart_v_emissions, path = here("Output", "subpart_v_emissions_by_facility_v1.xlsx"))
