...
fruit_vegetable_canning_emissions_by_unit = subpart_c 
...
fruit_vegetable_canning_emissions_by_unit_2023 = fruit_vegetable_canning_emissions_by_unit |>
...
export_facility_unit_data(
  ...
  file_type = "unit",
  datasets = list(
    "unit_emissions" = fruit_vegetable_canning_emissions_by_unit,
    "unit_emissions_2023" = fruit_vegetable_canning_emissions_by_unit_2023
  )
)