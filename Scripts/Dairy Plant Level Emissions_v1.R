...
# Ben Ladabaum                  
#                               
# Description:  Facility emissions data for dairy products (dry, condensed and evaporated)
#
# Notes:  
# 
# Inputs:   
...
dairy_products_dry_cond_evap_emissions_by_facility = subpart_c_emissions |>
...
dairy_products_dry_cond_evap_emissions_by_facility_2023 = dairy_products_dry_cond_evap_emissions_by_facility |>
...
export_facility_unit_data(
  ...
  file_type = "facility",
  datasets = list(
    "facility_emissions" = dairy_products_dry_cond_evap_emissions_by_facility,
    "facility_emissions_2023" = dairy_products_dry_cond_evap_emissions_by_facility_2023
  )
)