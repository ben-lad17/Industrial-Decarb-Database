...
# export
write_xlsx(subpart_ii_emissions, path = here("Output", "subpart_ii_emissions_by_facility_v1.xlsx"))
write_xlsx(subpart_hh_emissions, path = here("Output", "subpart_hh_emissions_by_facility_v1.xlsx"))
write_xlsx(subpart_s_emissions, path = here("Output", "subpart_s_emissions_by_facility_v1.xlsx"))