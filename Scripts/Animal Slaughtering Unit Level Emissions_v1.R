...
# animal slaughtering (non-poultry)
#
# Notes:  
# 
# Inputs:   
...
animal_slaughtering_emissions_by_unit = subpart_c 
...
animal_slaughtering_emissions_by_unit_2023 = animal_slaughtering_emissions_by_unit |>
  filter(reporting_year==2023)

### export ###
export_facility_unit_data(
  industry = "animal_slaughtering",
  version = "v1",
  file_type = "unit",
  datasets = list(
    "unit_emissions" = animal_slaughtering_emissions_by_unit,
    "unit_emissions_2023" = animal_slaughtering_emissions_by_unit_2023
  )
)
