...
# Ben Ladabaum                  
#                               
# Description:  Facility emissions data for spice and extract manufacturing
#
# Notes:  
# 
# Inputs:   
...
spice_extract_emissions_by_facility = subpart_c_emissions |>
...
spice_extract_emissions_by_facility_2023 = spice_extract_emissions_by_facility |>
...
export_facility_unit_data(
  ...
  file_type = "facility",
  datasets = list(
    "facility_emissions" = spice_extract_emissions_by_facility,
    "facility_emissions_2023" = spice_extract_emissions_by_facility_2023
  )
)