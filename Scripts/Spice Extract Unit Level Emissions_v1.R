...
spice_extract_emissions_by_unit = subpart_c 
...
spice_extract_emissions_by_unit_2023 = spice_extract_emissions_by_unit |>
  filter(reporting_year==2023)

### export ###
export_facility_unit_data(
  industry = "spice_extract",
  version = "v1",
  file_type = "unit",
  datasets = list(
    "unit_emissions" = spice_extract_emissions_by_unit,
    "unit_emissions_2023" = spice_extract_emissions_by_unit_2023
  )
)
