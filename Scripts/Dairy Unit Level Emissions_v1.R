...
# Ben Ladabaum                  
#                               
# Description:  Create dataset with unit-level process emissions for  
# dairy products (dry, condensed and evaporated)
#
# Notes:  
# 
# Inputs:   
...
dairy_products_dry_cond_evap_emissions_by_unit = subpart_c 
...
dairy_products_dry_cond_evap_emissions_by_unit_2023 = dairy_products_dry_cond_evap_emissions_by_unit |>
  filter(reporting_year==2023)

### export ###
export_facility_unit_data(
  industry = "dairy_products_dry_cond_evap",
  version = "v1",
  file_type = "unit",
  datasets = list(
    "unit_emissions" = dairy_products_dry_cond_evap_emissions_by_unit,
    "unit_emissions_2023" = dairy_products_dry_cond_evap_emissions_by_unit_2023
  )
)
