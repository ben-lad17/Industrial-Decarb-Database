...
soybean_oilseed_emissions_by_unit = subpart_c 
...
soybean_oilseed_emissions_by_unit_2023 = soybean_oilseed_emissions_by_unit |>
...
export_facility_unit_data(
  ...
  file_type = "unit",
  datasets = list(
    "unit_emissions" = soybean_oilseed_emissions_by_unit,
    "unit_emissions_2023" = soybean_oilseed_emissions_by_unit_2023
  )
)