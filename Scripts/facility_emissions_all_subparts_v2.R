...
subpart_g = read_excel(here("Output", "subpart_g_emissions_by_facility_v1.xlsx"))
...
subpart_v = read_excel(here("Output", "subpart_v_emissions_by_facility_v1.xlsx"))
subpart_x = read_excel(here("Output", "subpart_x_emissions_by_facility_v1.xlsx"))
...
write.xlsx(plant_level_emissions_combined_2023, here("Output", "facility_emissions_relevant_naics_2023.xlsx"))
