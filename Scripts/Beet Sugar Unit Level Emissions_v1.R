...
# Ben Ladabaum                  
#                               
# Description:  Create dataset with unit-level process emissions for beet sugar manufacturing.
#
# Notes:  
# 
# Inputs:   
...
beet_sugar_emissions_by_unit = subpart_c 
...
beet_sugar_emissions_by_unit_2023 = beet_sugar_emissions_by_unit |>
...
export_facility_unit_data(
  ...
  file_type = "unit",
  datasets = list(
    "unit_emissions" = beet_sugar_emissions_by_unit,
    "unit_emissions_2023" = beet_sugar_emissions_by_unit_2023
  )
)