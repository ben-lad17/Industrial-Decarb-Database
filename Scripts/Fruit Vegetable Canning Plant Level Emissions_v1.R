...
# Ben Ladabaum                  
#                               
# Description:  Facility emissions data for fruit and vegetable canning
#
# Notes:  
# 
# Inputs:   
...
fruit_vegetable_canning_emissions_by_facility = subpart_c_emissions |>
...
fruit_vegetable_canning_emissions_by_facility_2023 = fruit_vegetable_canning_emissions_by_facility |>
  filter(reporting_year==2023)

### export ###
export_facility_unit_data(
  industry = "fruit_vegetable_canning",
  version = "v1",
  file_type = "facility",
  datasets = list(
    "facility_emissions" = fruit_vegetable_canning_emissions_by_facility,
    "facility_emissions_2023" = fruit_vegetable_canning_emissions_by_facility_2023
  )
)