...
# Ben Ladabaum                  
#                               
# Description:  Facility emissions data for cheese manufacturing
#
# Notes:  
# 
# Inputs:   
...
cheese_emissions_by_facility = subpart_c_emissions |>
...
cheese_emissions_by_facility_2023 = cheese_emissions_by_facility |>
...
export_facility_unit_data(
  ...
  file_type = "facility",
  datasets = list(
    "facility_emissions" = cheese_emissions_by_facility,
    "facility_emissions_2023" = cheese_emissions_by_facility_2023
  )
)